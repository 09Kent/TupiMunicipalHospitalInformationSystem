    ...
    public static function getConnection(): PDO
    {
        if (self::$instance === null) {
            try {
                ...
                // Return clean JSON if API request or throw error
                ...
                die("<h1>Database Connection Error</h1><p>" . htmlspecialchars($e->getMessage()) . "</p><p>Please make sure MySQL is running.</p>");
            }
        }
